            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                    <div class="relative w-full sm:w-72 group">
                        ...
                        <Input v-model="searchQuery" placeholder="Filter project types..." :class="FLAT_SEARCH_INPUT" />
                    </div>

                    <Link href="/project-types/create">
                        <Button class="w-full sm:w-auto h-12 px-8">
                ...
                <div v-if="orgTypes.length > 0">
                    ...
                    <ResourceList :items="orgTypes">
                        <template #default="{ item: type }">
                            <div :class="['rounded-md transition-colors p-3 space-y-4', FLAT_ROW_HOVER]">
                                ...
                                <div v-if="isSuperAdmin" class="flex items-center gap-2 pt-2 px-1 border-t border-gray-100 dark:border-gray-800">
                                    <select
                    ...
                    <ResourceList :items="globalTypes">
                        <template #default="{ item: type }">
                            <div :class="['rounded-md transition-colors p-3 space-y-4', FLAT_ROW_HOVER]">
                                ...
                                <div v-else-if="isOrgAdmin" class="pt-2 px-1 border-t border-gray-100 dark:border-gray-800">
