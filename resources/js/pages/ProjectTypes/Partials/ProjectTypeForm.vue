...
<template>
    <form @submit.prevent="submit" class="space-y-10">
        <div v-show="activeTab === 'general'" class="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-400">
        ...
        <div v-show="activeTab === 'schema'" class="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-400">
        ...
        <div v-show="activeTab === 'workflow'" class="space-y-4 animate-in fade-in duration-300">
            <div class="flex items-center justify-between px-1">
