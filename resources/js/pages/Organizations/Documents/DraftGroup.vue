            ...
            <nav class="border-b bg-light-background dark:border-gray-800 px-6 py-4">
                <div class="flex items-center justify-between">
                    <button
                        ...
                        class="flex items-center gap-2 text-sm text-slate-500 hover:text-projector-primary-600 transition-colors cursor-pointer bg-transparent border-0 p-0"
                    >
                ...
                <div class="grid grid-cols-12 gap-12">
                                ...
                                >
                                    <template #trigger>
                                        <Button
                                            size="sm"
                                            variant="ghost"
                                            class="text-[10px] font-black uppercase tracking-widest text-projector-primary-600 hover:bg-projector-primary-50 dark:hover:bg-projector-primary-950 rounded-lg h-9 px-3"
                                        >
                            ...
                            <div v-if="isEditing" class="p-6 space-y-4">
                                <div class="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        class="w-full rounded-xl border border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800 px-4 py-2.5 text-sm font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-projector-primary-500"
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        rows="20"
                                        class="w-full rounded-xl border border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800 px-4 py-3 text-xs text-slate-700 dark:text-slate-300 font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-projector-primary-500 resize-y"
                                    />
                                </div>
                    ...
                    <aside class="col-span-12 lg:col-span-4 space-y-4">
                        ...
                        <Button
                            ...
                            @click="commit"
                            class="w-full bg-projector-primary-600 hover:bg-projector-primary-700 text-white rounded-xl h-11 text-[10px] font-black uppercase tracking-widest"
                        >
